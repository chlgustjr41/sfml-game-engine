...
const int CharacterMovableObject::JUMP_HEIGHT = 2;
const int CharacterMovableObject::JUMP_FRAME = 60;
...
bool CharacterMovableObject::getScriptIsMovingLeft()
{
    return scriptIsMovingLeft;
}
bool CharacterMovableObject::getScriptIsMovingRight()
{
    return scriptIsMovingRight;
}
...
void CharacterMovableObject::setScriptIsMovingLeft(bool flag)
{
    scriptIsMovingLeft = flag;
}
void CharacterMovableObject::setScriptIsMovingRight(bool flag)
{
    scriptIsMovingRight = flag;
}

void CharacterMovableObject::run()
{
    sf::RectangleShape *thisObject = MovableObject::getMovingObject();
    duration = MovableObject::getDuration();
