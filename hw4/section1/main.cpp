...
int main(int argc, char *argv[])
{
    ...
    CharacterObject *character = new CharacterObject(eventManager, characterShape, characterBoundary, 1, CHARACTER_COLORS[0], &platforms);
    // Characters
    ...
    ViewObject *view = new ViewObject(eventManager, viewBoundary, characterShape, 1);
    ...
    DeathZoneObject *deathZone = new DeathZoneObject(eventManager, deathZoneShape, spawnZoneShape, &characters);
