...
VerticallyMovingPlatformObject::VerticallyMovingPlatformObject(sf::RectangleShape *initialObjectShape, int initialIndex, double movementLength)
    : GameObject(GameObject::VERTICALLY_MOVING_PLATFORM_OBJECT_TYPE,
                 ...
                 new MovingPlatformNetworkObject(GameObject::VERTICALLY_MOVING_PLATFORM_OBJECT_TYPE, initialIndex, initialObjectShape))
{
}
