...
ViewObject::ViewObject(sf::RectangleShape *initialObjectShape,
    ...
    : GameObject(GameObject::VIEW_OBJECT_TYPE, new RenderableObject(initialObjectShape), new ViewMovableObject(GameObject::CHARACTER_OBJECT_TYPE, initialObjectShape, gameCharacter))
{
}
